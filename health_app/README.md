...
A zero-dependency web app that lets a user upload a food/product image or search by product name, identifies the product, searches the web for nutrition evidence, and passes the result through multiple nutrition agents.
